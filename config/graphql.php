...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'complaints' => App\GraphQL\Queries\ComplaintQuery::class,
                'profile' => App\GraphQL\Queries\MyProfileQuery::class,
            ],
            'mutation' => [
                ...
                'createComplaint' => App\GraphQL\Mutations\CreateComplaintMutation::class,
            ],
    ...
    'types' => [
        ...
        'Complaint' => App\GraphQL\Types\ComplaintType::class,
        'AuthPayload' => App\GraphQL\Types\AuthPayloadType::class,
        'Logout' => App\GraphQL\Types\LogoutType::class,
    ],
